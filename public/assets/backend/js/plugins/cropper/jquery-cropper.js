...
!function (t) {
    ...
    function l(t, i) {
        var e, s, a = wt(t.degree) % 180, o = (a > 90 ? 180 - a : a) * Math.PI / 180, h = xt(o), n = Ct(o), r = t.width, p = t.height, l = t.aspectRatio;
        return i ? (e = r / (n + h / l), s = e / l) : (e = r * n + p * h, s = r * h + p * n), {width: e, height: s}
    }

    function c(e, s) {
        var a, o, h, n = t("<canvas>")[0], r = n.getContext("2d"), p = 0, c = 0, d = s.naturalWidth, g = s.naturalHeight, u = s.rotate, f = s.scaleX, m = s.scaleY, v = i(f) && i(m) && (1 !== f || 1 !== m), w = i(u) && 0 !== u, x = w || v, C = d, b = g;
    ...
    function u(t) {
        var i, e, s, a, o, h, n, r, p, l, c = new y(t), d = c.byteLength;
    ...
    function f(t) {
        var i, e = t.replace(V, ""), s = atob(e), a = s.length, o = new b(a), h = new B(o);
        for (i = 0; a > i; i++)h[i] = s.charCodeAt(i);
        return o
    }

    function m(t) {
        var i, e = new B(t), s = e.length, a = "";
    ...
    v.prototype = {
        constructor: v, init: function () {
            ...
            s.checkCrossOrigin && o(r) && (p = a.prop("crossOrigin"), p ? i = r : (p = "anonymous", i = h(r))), this.crossOrigin = p, this.crossOriginUrl = i, this.$clone = e = t("<img" + n(p) + ' src="' + (i || r) + '">'), this.isImg ? a[0].complete ? this.start() : a.one(U, t.proxy(this.start, this)) : e.one(U, t.proxy(this.start, this)).one(I, t.proxy(this.stop, this)).addClass(T).insertAfter(a)
        }, start: function () {
            ...
            var i, e = this.options.viewMode, s = this.container, a = s.width, o = s.height, h = this.image, n = h.naturalWidth, r = h.naturalHeight, p = 90 === wt(h.rotate), l = p ? r : n, c = p ? n : r, d = l / c, g = a, u = o;
            ...
            var i = this.options, e = this.canvas, s = i.aspectRatio, a = ft(i.autoCropArea) || .8, o = {
                width: e.width,
                height: e.height
            };
            ...
            var i = n(this.crossOrigin), e = i ? this.crossOriginUrl : this.url;
            ...
            this.isCropped && !this.isDisabled && (this.$viewBox.find("img").css({
                ...
                var e = t(this), s = e.data(J), c = s.width, d = s.height, g = c, u = d, f = 1;
            ...
            var e = i.originalEvent || i, s = ft(this.options.wheelZoomRatio) || .1, a = 1;
            ...
            if (!this.isDisabled) {
                ...
                if (s = s || t(n.target).data(tt), K.test(s)) {
                    if (this.trigger(A, {originalEvent: o, action: s}).isDefaultPrevented())return;
            ...
            if (!this.isDisabled) {
                ...
                if (h) {
                    if (this.trigger(N, {originalEvent: s, action: h}).isDefaultPrevented())return;
            ...
            return this.isBuilt && this.isCropped && ut ? (t.isPlainObject(i) || (i = {}), g = this.getData(), e = g.width, s = g.height, p = e / s, t.isPlainObject(i) && (h = i.width, n = i.height, h ? (n = h / p, r = h / e) : n && (h = n * p, r = n / s)), a = yt(h || e), o = yt(n || s), l = t("<canvas>")[0], l.width = a, l.height = o, d = l.getContext("2d"), i.fillColor && (d.fillStyle = i.fillColor, d.fillRect(0, 0, a, o)), d.drawImage.apply(d, function () {
                    var t, i, a, o, h, n, p = c(this.$clone[0], this.image), l = p.width, d = p.height, u = [p], f = g.x, m = g.y;
