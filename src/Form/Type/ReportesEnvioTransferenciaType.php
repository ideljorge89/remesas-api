...
class ReportesEnvioTransferenciaType extends AbstractType
{
    private $reportesId;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->add('reportes', EntityType::class, array(
                ...
                'class' => TnReporteTransferencia::class,
        ...
        $builder->addEventListener(
            ...
            function (FormEvent $event) {
                ...
                if (count($form->getData()->getReportes()) == 0) {
                    $form->get('reportes')->addError(new FormError('Para exportar debe seleccionar al menos 1 reporte, revise.'));
                }
            });
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'data_class' => ReporteEnvioTransferenciaModel::class,
        ]);
    }
}
