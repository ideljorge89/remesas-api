...
/**
 * @Gedmo\Loggable()
 * @ORM\Entity(repositoryClass="App\Repository\TnOperacionAgenteRepository")
 */
class TnOperacionAgente
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
     ...
     * @Assert\NotNull()
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\TnAgente", inversedBy="porcentajes")
     */
    private $agente;
     ...
     * @Assert\NotNull()
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\NmGrupoPagoAgente", inversedBy="porcentajes")
     */
