...
class UpdateMunicipioCommand extends ContainerAwareCommand
{
    protected static $defaultName = 'update:distribucion';

    private $csvParsingOptions = array(
        'finder_in' => 'data',
        'finder_name' => 'distribucion.csv',
    ...
    {
        $this
            ->setDescription('Actualiza los precios de distribución de los municipios');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($csv as $data) {
            ...
            if ($municipio instanceof NmMunicipio) {
                $municipio->setTasaFija($data['Distribucion']);
